...
<template>
  <div>
    <!-- <Editor api-key="14zuai56qyski8o0li3olx3d7my3a5jislf3c6v2it46okeh" /> -->
    <div class="px-16 py-32 bg-ivory flex flex-col items-center justify-center">
      <img src="@/assets/img/IPSBI-LOGO-FINAL.png" class="w-1/5 mb-5">
      <p class="text-5xl font-medium display text-darkSlate w-2/5 text-center leading-relaxed">
        Ikatan Program Studi Bioteknologi Indonesia
      </p>

      <p class="w-3/5 text-center mt-3 text-lg">
    ...
    <div class="flex w-full">
      <div class="flex flex-col gap-5 w-1/2 p-16 bg-keppel text-white">
        <p class="display text-4xl tracking-wide">Visi</p>
      ...
      <div class="flex flex-col gap-5 w-1/2 p-16 bg-zomp text-white">
        <p class="display text-4xl tracking-wide">Misi</p>
        
        <ol type="1" class="list-decimal ml-4 leading-7  *:pb-3">
          <li>Memelihara integritas, komitmen dan kompetensi anggota.</li>
          <li>Berkoordiansi secara intens dengan Pemerintah dalam menetapkan acuan dan panduan kurikulum Bioteknologi yang akan di akreditasi.</li>
          <li>Berpartisipasi aktif dalam segala permasalahan terkait dengan perkembangan keilmuan Bioteknologi bagi perkembangan kurikulum program studi Bioteknologi.</li>
        </ol>
      </div>
    </div>

    <div class="flex flex-col gap-5 p-16 bg-darkSlate text-white">
      <p class="display text-4xl tracking-wide">Tujuan</p>

      <ol type="1" class="list-decimal ml-4 leading-7 *:pb-3">
        <li>Perkumpulan dimaksudkan agar dapat menghimpun Program studi Bioteknologi Indonesia untuk menjadi penggerak Pembangunan Nasional dalam mewujudkan masyarakat adil dan makmur berdasarkan Pancasila dan Undang – Undang Dasar Negara Kesatuan Republik Indonesia.</li>
        <li>Perkumpulan bertujuan untuk mengembangkan Kurikulum Program Studi Bioteknologi dan mendayagunakan potensi program studi S1, S2 dan S3 di seluruh Indonesia sehingga dihasilkan lulusan Program Studi Bioteknologi yang dapat berdharmabakti bagi kepentingan Bangsa dan Negara Indonesia.</li>
        <li>Perkumpulan berfungsi sebagai wadah komunikasi yang menjembatani anggota dengan berbagai latar belakang Pendidikan dan Penelitian di bidang Bioteknologi, sehingga terjalin kerjasama yang bersifat sinergi secara serasi, seimbang dan selaras.</li>
      </ol>
    </div>

    <div class="px-16 py-32 bg-ivory flex flex-col items-center justify-center">
      <div class="pb-20 px-20">
        <p class="text-4xl font-medium display text-darkSlate mb-5">Sejarah Kami</p>
        <p class="leading-loose text-justify">
