            ...
            <table class="table-auto">
                <thead class="bg-keppel text-white">
                    <tr>
                        ...
                        <th class="p-3 font-semibold tracking-wide text-left">Author</th>
                ...
                <tbody>
                    <tr class="border-b-2 border-gray-100">
                        ...
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Nama author</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Ini adalah komentar dari author.</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Post 1</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
