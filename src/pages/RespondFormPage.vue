    ...
    <div class="flex flex-col gap-10">
        <div class="flex justify-between items-center w-full h-fit">
            <div class="flex gap-3 w-1/3">
                <input class="bg-white w-full rounded-xl px-3 py-2 border-2 border-keppel outline-none" placeholder="Cari komentar...">
            ...
            <table class="table-auto">
                <thead class="bg-keppel text-white">
                    <tr>
                        ...
                        <th class="p-3 font-semibold tracking-wide text-left">Input 1</th>
                        <th class="p-3 font-semibold tracking-wide text-left">Input 2</th>
                        <th class="p-3 font-semibold tracking-wide text-left">Input 3</th>
                ...
                <tbody>
                    <tr class="border-b-2 border-gray-100">
                        ...
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Senin, 12 Oktober 2024</p>
                        </td>
