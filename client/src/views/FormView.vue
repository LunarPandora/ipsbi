...
<template>
    <div class="px-16 py-32 bg-ivory flex flex-col items-center justify-center">
        <p class="display text-semibold text-6xl text-darkSlate">Daftar Form</p>
        <p class="w-3/4 text-center pt-5 text-md">Akses form yang anda perlukan mengenai IPSBI disini.</p>
