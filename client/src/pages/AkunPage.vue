            ...
            <table class="table-auto">
                ...
                <tbody>
                    <tr class="border-b-2 border-gray-100">
                        ...
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">admin1@gmail.com</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Adminstrator</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">0</p>
                        </td>
                    ...
                    <tr class="border-b-2 border-gray-100">
                        ...
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Admin 2</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">admin2@gmail.com</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Adminstrator</p>
                        </td>
                    ...
                    <tr class="border-b-2 border-gray-100">
                        ...
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Admin 3</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">admin3@gmail.com</p>
                        </td>
                        <td class="p-3 bg-white tracking-wide">
                            <p class="text-sm">Adminstrator</p>
                        </td>
